<?php defined('K2F') or die;
	...
	/**
	 * A class which converts wiki text to html.
	 * @copyright 2010 Covac Software
	 * @author Christian Sciberras
	 * @version 01/01/2011 - Initial implementation.
	 */
	class WikiPreprocessor extends Preprocessor {
		public function process(){
			$this->finished=false;
			try {
				$wiki=new SimpleWiki($this->original);
				$this->converted=$wiki->get_html();
				$this->finished=true;
